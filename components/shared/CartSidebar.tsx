...
import { Card, PrimaryButton, Button } from '../ui';
import { fmt } from '../../constants';
import { RefreshCw, Calendar, FileText, Hash, DollarSign } from 'lucide-react';
...
export const CartSidebar: React.FC<CartSidebarProps> = ({ isVMI, cartItems, cartSubtotal, cartTotalItems, handleOrderSubmit, activeTab, onTabChange, orderHistory, onReorder }) => {
    ...
    return (
        <Card className="flex flex-col h-full shadow-lg">
            ...
            <div className="flex border-b mx-4">
                ...
                >
                    {isVMI ? 'Current Proposal' : 'Your Order'}
                </button>
                <button
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                {activeTab === 'order' && (
                    <>
                        ...
                        <div className="p-4 border-t space-y-4 bg-gray-50/50 rounded-b-lg">
